...
/**
 * Catalog activity for showing the list of users that admin can access
 *
 */
...
public class CatalogActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCursorAdapter = new UserAdapter(this, null);
        ...
        itemsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent editIntent = new Intent(CatalogActivity.this, SignupActivity.class);
                Uri currentItemUri = ContentUris.withAppendedId(UsersEntry.CONTENT_URI, id);
    ...
    */
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        return new CursorLoader(this,   // Parent activity context
                UsersEntry.CONTENT_URI,   // Provider content URI to query
